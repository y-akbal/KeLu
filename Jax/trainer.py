...
class TraininingArgs:
    ## Project Details
    project_name:str = "KeLu_vs_Gelu_CIFAR100_"
    group_name:str = "KeLu"
    name:str = "KeLu"
    ## Train Kwargs
    epochs:int = 100
...
def train_step(state, x_batched, y_batched):
    ...
    def loss_fn(params):
        ...
        return optax.softmax_cross_entropy(logits, y_batched).mean(), (updates, logits)
...
def main():
    ...
    lr_scheduler = optax.warmup_cosine_decay_schedule(0.0006, 0.01, 20, args.epochs, end_value=0.0003, exponent=1.0)
